 ...
 *            (C)  2014 sooraj Surendran <soorajj@me.com>
 *
 *  Based on the wheatley governor
 *
...
static void sooplus_powersave_bias_init_cpu(int cpu)
{
...
static void sooplus_powersave_bias_init(void)
{
    int i;
    for_each_online_cpu(i) {
	sooplus_powersave_bias_init_cpu(i);
    }
}
...
/* cpufreq_sooplus Governor Tunables */
...
static void dbs_check_cpu(struct cpu_dbs_info_s *this_dbs_info)
{
	...
	/*
	 * For the purpose of sooplus, waiting for disk IO is an
				...
				unsigned int event)
{
	...
	this_dbs_info->rate_mult = 1;
	sooplus_powersave_bias_init_cpu(cpu);
	num_misses = 0;
	/*
...
MODULE_AUTHOR("Sooraj Surendran <soorajj@me.com>");
MODULE_DESCRIPTION("'cpufreq_sooplus' - A dynamic cpufreq governor for "
